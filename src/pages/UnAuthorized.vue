<template>
	<div class="h-screen w-screen bg-gray-100 flex items-center justify-center">
		...
		>
			<div class="max-w-lg flex flex-col space-y-3">
				<div class="text-9xl font-dark font-bold">403</div>
				<h1 class="text-2xl md:text-3xl font-light leading-normal">
					Désolé, vous n'avez pas l'autorisation d'accéder à cette
					page.
				</h1>
			</div>
			<div class="flex max-w-lg justify-start md:justify-center w-full">
				<svg
					id="Layer_1"
					data-name="Layer 1"
